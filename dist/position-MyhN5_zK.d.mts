import { L as Layout, d as LayoutItem, C as CompactType, M as Mutable, w as CompactContext, b as Compactor, P as Position, p as PositionStrategy, R as ResizeHandleAxis } from './types-Csm0sQpy.mjs';
 ...
 */
declare function getAnchors(layout: Layout): LayoutItem[];
/**
 ...
 */
declare function getFixedItems(layout: Layout, context?: CompactContext): LayoutItem[];
/**
 * Clone a layout item.
 *
...
export { resizeItemInDirection as A, resolveCompactionCollision as B, transformStrategy as C, verticalOverlapCompactor as D, withLayoutItem as E, cloneLayoutItem as a, bottom as b, cloneLayout as c, getLayoutItem as d, setTransform as e, verticalCompactor as f, getCompactor as g, horizontalCompactor as h, absoluteStrategy as i, compactItemHorizontal as j, compactItemVertical as k, correctBounds as l, moveElement as m, noCompactor as n, createScaledStrategy as o, defaultPositionStrategy as p, getAnchors as q, getFixedItems as r, setTopLeft as s, getStatics as t, horizontalOverlapCompactor as u, validateLayout as v, modifyLayout as w, moveElementAwayFromCollision as x, noOverlapCompactor as y, perc as z };
